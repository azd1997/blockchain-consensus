...
type Junker interface {
	Handler1(args string, reply *int)
	Handler2(args int, reply *string)
	Handler3(args int, reply *int)
	Handler4(args *JunkArgs, reply *JunkReply)
	Handler5(args JunkArgs, reply *JunkReply)
}
...
func TestBasicViaInterface(t *testing.T) {
	runtime.GOMAXPROCS(4)
